...
class Block {
    ...
    getBData() {
        ...
        let encoded_body = this.body;
        // Decoding the data to retrieve the JSON representation of the object
        let decoded_body = hex2ascii(encoded_body);
        // Parse the data to an object to be retrieved.
        let json_body = JSON.parse(decoded_body);
        // Resolve with the data if the object isn't the Genesis block
        if(json_body['data'] !== "Genesis Block"){
            return json_body['data'];
        } else {
            return "Block is the Genesis Block - No Decryption needed.";
        }
    }
