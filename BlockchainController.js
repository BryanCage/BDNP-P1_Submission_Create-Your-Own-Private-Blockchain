...
class BlockchainController {
            ...
            if (req.body.address && req.body.message && req.body.signature && req.body.star) {
                ...
                try {
                    ...
                    if (block) {
                        ...
                        return res.status(500).send("Elapsed Time greater than 5 minutes - Cannot Add Block!");
                    }
                } catch (error) {
    ...
    // This endpoint allows you to request the validity of the blockchain
